...
function agregarAlCarrito(id) 
{
    ...
    //es el operador NOT (negación lógica) en JavaScript. Invierte un valor booleano: convierte true en false, y false en true.
    if(!producto) 
    {
...
// SACAR UN PRODUCTO DEL CARRITO POR COMPLETO (sin importar la cantidad)
function quitarDelCarrito(id)
{

    // .filter recorre el carrito y devuelve un arreglo NUEVO
    // dejando afuera al producto cuyo id coincide con el que queremos sacar
    ...
    carrito.forEach(producto => 
    {
        ...
        <div class="card mb-2">
            <div class="card-body">
                ...
                <div class="mt-2">
                    <button class="btn btn-sm btn-outline-danger" onclick="quitarDelCarrito(${producto.id})">
...
// FINALIZAR COMPRA (simulada, no hay pago real)
function finalizarCompra()
{
    ...
    alert("¡Gracias por tu compra! (Esto es una simulacion, no hay pago real).");
